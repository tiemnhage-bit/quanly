...
export async function POST(request){
  try{
    ...
    // Auth dùng email nội bộ để không cần SMS/OTP ở giai đoạn Free Beta.
    // Người dùng không nhìn thấy và luôn đăng nhập bằng số điện thoại.
    const loginEmail=`p${phone}@users.quanlyquan.local`;
